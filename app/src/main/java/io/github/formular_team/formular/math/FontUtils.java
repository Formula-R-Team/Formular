...
public class FontUtils
{
	...
	{
		double ax = contour.get( verts.get( u ) ).x();
		double ay = contour.get( verts.get( u ) ).y();

		double bx = contour.get( verts.get( v ) ).x();
		double by = contour.get( verts.get( v ) ).y();

		double cx = contour.get( verts.get( w ) ).x();
		double cy = contour.get( verts.get( w ) ).y();
		...
		for ( int p = 0; p < n; p++ )
		{
			...
			double px = contour.get( verts.get( p ) ).x();
			double py = contour.get( verts.get( p ) ).y();
