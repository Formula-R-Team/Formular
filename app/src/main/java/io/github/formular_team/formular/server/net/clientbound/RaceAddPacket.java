...
public class RaceAddPacket implements Packet {
    ...
    public RaceAddPacket(final Parcel source) {
    ...
    public static final Creator<RaceAddPacket> CREATOR = new Creator<RaceAddPacket>() {
        @Override
        public RaceAddPacket createFromParcel(final Parcel source) {
            return new RaceAddPacket(source);
        }

        @Override
        public RaceAddPacket[] newArray(final int size) {
            return new RaceAddPacket[size];
        }
    };
}
