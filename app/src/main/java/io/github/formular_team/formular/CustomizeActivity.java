...
public final class CustomizeActivity extends FormularActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        this.slider.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(final SeekBar seekBar, final int progress, final boolean fromUser) {
                if (CustomizeActivity.this.kart != null) {
                    CustomizeActivity.this.kart.setColor(new Color(this.getArgb(seekBar)));
                }
            }
        ...
        final WeakOptional<CustomizeActivity> act = WeakOptional.of(this);
